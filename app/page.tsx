export default function Home() {
    ...
    <li><a href="#contact" className="hover:underline">Contacto</a></li>
      ...
      <div className="relative h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/cerrodelasilla.jpg')" }}>
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 text-white">
          ...
          <img src="/logo.webp" alt="Logo" className="mt-8 w-24 h-auto" />
        </div>
      </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    <div className="bg-white shadow rounded p-4">
      <img src="/acueductomonterrey.jpeg" alt="Proyecto 1" className="w-full h-48 object-cover rounded" />
    ...
    <div className="bg-white shadow rounded p-4">
      <img src="/acueductoguadalajara.jpg" alt="Proyecto 2" className="w-full h-48 object-cover rounded" />
      <h3 className="text-xl font-bold mt-4">Proyecto 2</h3>
      <p className="text-gray-600 mt-2">Acueducto de acero de 54" de 6.0 km de longitud, el salto-calderon.</p>
    </div>
    <div className="bg-white shadow rounded p-4">
      <img src="/tanqueeleden.jpg" alt="Proyecto 3" className="w-full h-48 object-cover rounded" />
      <h3 className="text-xl font-bold mt-4">Proyecto 3</h3>
      <p className="text-gray-600 mt-2">Acueducto de acero de 30" de 42.0 km de longitud, armeria-manzanillo.</p>
    </div>
  </div>
</section>
